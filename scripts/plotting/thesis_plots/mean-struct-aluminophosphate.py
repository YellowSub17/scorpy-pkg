...
ip1 = InsetPosition(axes, [0.5, 0.01, 0.49, 0.425])
inset_axes1.set_axes_locator(ip1)
mark_inset(axes, inset_axes1, loc1=2, loc2=3, fc='0.75', ec='none')
...
inset_axes1.set_xticks([107, 110])
inset_axes1.set_yticks([107, 110])
inset_axes1.xaxis.tick_top()
