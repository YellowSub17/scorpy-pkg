...
plt.figure()
plt.imshow(np.log10(im4_0+1), origin='lower')
plt.title('corr N4_0 q1=q2 log10(I)')

plt.figure()
plt.imshow(np.log10(im4_1+1), origin='lower')
plt.title('corr N4_1 q1=q2 log10(I)')

plt.figure()
plt.imshow(np.log10(im4_1+1)*np.log10(im4_0+1), origin='lower')
plt.title('corr N4_1*N4_0 q1=q2 log10(I)')


plt.figure()
plt.imshow(np.log10(im1024_0+1), origin='lower')
plt.title('corr N1024_0 q1=q2 log10(I)')


plt.figure()
plt.imshow(np.log10(im1024_1+1), origin='lower')
plt.title('corr N1024_1 q1=q2 log10(I)')

plt.figure()
plt.imshow(np.log10(im1024_1+1)*np.log10(im1024_0+1), origin='lower')
