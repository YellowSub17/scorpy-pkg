...
print(f'Correlating {xtal_size} chunk {chunk}')
...
for i_frame in range(512):
    ...
    npz_chunk_dir =  f'{data_dir}/frames/{xtal_size}-{geom_code}/{chunk}'
    npz_path = f'{npz_chunk_dir}/{pdb_code}-{xtal_size}-{geom_code}-{chunk}-{i_frame}.npz'
    ...
    corr_chunk_dir =  f'{data_dir}/qcor/{xtal_size}-{geom_code}/{chunk}'
    qcor_path = f'{corr_chunk_dir}/{pdb_code}-{xtal_size}-{geom_code}-{chunk}-{i_frame}-qcor.npy'
