...
thresh_bounds = np.arange(0, 81e3, 5e3)
...
for i_thresh_bound, thresh_bound in enumerate(thresh_bounds[:-1]):
    ...
    corr_a = scorpy.CorrelationVol(nq=200, npsi=5760, qmax=1.5, qmin=0.4, cos_sample=False)
    corr_b = scorpy.CorrelationVol(nq=200, npsi=5760, qmax=1.5, qmin=0.4, cos_sample=False)
    ...
    corr_a_fname = f'{datapath}/qcor/thresh_d5k/p11_allruns_d5k_{i_thresh_bound}_a_qcor.dbin'
    ...
    corr_b_fname = f'{datapath}/qcor/thresh_d5k/p11_all_d5k_{i_thresh_bound}_b_qcor.dbin'
