...
for i_frame in range(256, 512):
    ...
    corr = scorpy.CorrelationVol(nq=200, npsi=360, qmax=1.5, qmin=0.4, cos_sample=False)
    ...
    qcor_path = f'{corr_chunk_dir}/{pdb_code}-{xtal_size}-{geom_code}-{super_chunk}-{chunk}-{i_frame}-qcor'
