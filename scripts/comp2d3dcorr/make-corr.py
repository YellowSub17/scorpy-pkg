...
corrfname = 'inten1-qmax0264-2d-ssph-batch-int-noselfcorr-qcor.dbin'



corr = scorpy.CorrelationVol(nq=100, npsi=180, qmax=qmax, cos_sample=False, inc_self_corr=False)
...
for batch in range(nbatches):
    ...
    for frame in range(1, nframes+1):
        ...
        corr.fill_from_peakdata(pk, method=method, verbose=0)

    # print(99*' ', end='')



    corr.save(f'{scorpy.DATADIR}/dbins/{corrfname}')
