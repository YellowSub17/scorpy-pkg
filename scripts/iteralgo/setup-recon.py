...
cifpath = f'{scorpy.DATADIR}/xtal/nacl/'


a.setup_recon(f'{cifpath}nacl-sf.cif', f'{cifpath}nacl.cif', 256, 360*32, 180, 40, 9, 0.1, [1,1,1], np.radians(30), 2)




# a.make_target(f'{scorpy.DATADIR}/xtal/nacl/nacl-sf.cif')
# a.make_support(f'{scorpy.DATADIR}/xtal/nacl/nacl.cif')
# a.make_data()
