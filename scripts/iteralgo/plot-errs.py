...
# y1 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200.log', delimiter=',', skiprows=0, usecols=0)
# y2 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200_ER_200.log', delimiter=',', skiprows=0, usecols=0)
# y3 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200_ER_200_HIO_200.log', delimiter=',', skiprows=0, usecols=0)
# y4 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200_ER_200_HIO_200_ER_200.log', delimiter=',', skiprows=0, usecols=0)
# y5 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200_ER_200_x2_HIO_200.log', delimiter=',', skiprows=0, usecols=0)
# y6 = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_x3/errs_HIO_200_ER_200_x2_HIO_200_ER_200.log', delimiter=',', skiprows=0, usecols=0)
...
y = np.loadtxt(f'{scorpy.DATADIR}/algo/HIO_ER_fcc_a/errs_HIO_ER_fcc_a.log', delimiter=',', skiprows=0, usecols=0)
...
s = scorpy.SphericalVol(path=f'{scorpy.DATADIR}/algo/HIO_ER_fcc_a/sphv_HIO_ER_fcc_a_720.dbin')
...
# blqq_data.plot_slice(0, 124)

# plt.figure()
# plt.plot(blqq_data.vol[qq,qq,:])
