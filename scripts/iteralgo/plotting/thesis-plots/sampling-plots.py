...
axes[0].set_title('Radial Sampling')
...
axes[0].legend(bbox_to_anchor=(1,1), loc="upper right", framealpha=1, title='$nL$')
axes[1].legend(bbox_to_anchor=(1,1), loc="upper right", framealpha=1, title='$nL$')
axes[0].set_title('Angluar Sampling')
fig.tight_layout()
